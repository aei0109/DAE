...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        with tf.variable_scope("autoencoder_model"):
            ...
            noise_input, ae_reconstruction = sess.run([c_x, output],feed_dict={x: mnist.test.images * np.random.randint(2, size=(784)), phase_train: True, corrupt: 1})

            plt.imshow(noise_input[0].reshape((28,28)), cmap=plt.cm.gray)
            plt.show()
